...
### 第七階段：樣本擴大——5 個額外展覽的一致性驗證

2026-04-13 依使用者建議擴大樣本，從 curations 頁找到兩個原住民族相關主題館（臺南市原民會三館、屏東縣霧臺鄉魯凱族文物館），並檢查 5 個涵蓋不同族群與主題的展覽：

| # | 展覽 | 族群 | URL |
|---|------|------|-----|
| 1 | 《夜祭》西拉雅族祭儀主題特展 | 西拉雅 | /muse/exhibition/0596b21ec4a880ab501019436f4ae66b |
| 2 | 《cou‧祭時刻》原鄒文學與影像敘事主題特展 | 鄒族 | /muse/exhibition/5b1f7cd4ff889805e6e417fbcf90301d |
| 3 | Yokeoasu‧憶起鄒Cou | 鄒族 | /muse/exhibition/5be5aa0d403b2977de39a81c0f167f9b |
| 4 | 服飾看見魯凱社會對男性的期許 | 魯凱族 | /muse/exhibition/061e0412fa7ade2b7327e60964a9b5fc |
| 5 | 《生命‧文化‧流動》阿瀨Arucanglj排灣圖紋創作展 | 排灣族 | /muse/exhibition/7fac5412c2c65af7e9607665182842bd |

加上第六階段的阿美族《「釀」在生活中》共 **6 個展覽、5 個族群**。

**一致出現的實踐元素**：

| 實踐 | 出現率 |
|------|--------|
| 族社／部落／聚落直接列為協辦或主辦 | 5/6（6 僅限個人藝術家展） |
| 策展團隊含族人（具族名者或族內承擔者） | 6/6 |
| 族名／漢名並列標示 | 6/6（Ljumasang Ruviljivilje、Pasuya Noacahiyana 等） |
| 族人顧問、部落研究員或族語校正者 | 4/6 |
| 領袖家屬或族社的明示授權 | 2/6（在祭儀或傳統領袖相關展覽出現） |
| 展覽目的明述「文化傳承／復振／族群認同」 | 6/6 |

**特別值得記錄的具體案例**：
- **Yokeoasu 憶起鄒**：誌謝頁有「**影像授權**」與「**圖片授權**」分層欄位；族語校正者 2 位、田調採訪 7 位（含族人）、領袖家屬 2 家（汪念月、汪傳發）分別授權——接近國際 TK Labels 精神的實踐（雖未採 TK 標示格式）
- **夜祭**：10 個西拉雅聚落作為協辦單位，策展顧問段洪坤（知名西拉雅族文化工作者）
- **魯凱族男子服飾**：策展人全為族人（巴秀芬、顏文成、柯玉卿、道卡夫‧達瑪努安），有「部落研究員貝若桑」角色

**結論——可支撐 CARE/OCAP 多個維度 implemented 評級（限定範圍）**：

6 個展覽橫跨 5 個族群，實踐模式相當一致：族人主體性、族社參與、授權分層、族名並列等並非偶然，而是**原住民族相關機構策展的系統性實踐**。依此升級以下 6 個治理格：
- CARE 1.2 Authority to Control: partial → **implemented**
- CARE 1.3 Responsibility: partial → **implemented**
- CARE 1.4 Ethics: partial → **implemented**
- OCAP 2.2 Control: partial → **implemented**
- CARE 1.1 Collective Benefit: none → **partial**（展覽目的明述文化傳承／復振／族群認同）
- OCAP 2.1 Ownership: none → **partial**（族人／族社／領袖家屬的授權分層明確）

**仍必須明示的限定**：
- 本評估的 6 個展覽全部來自**原住民族相關機構策展**（原民會、族文物館、族社協辦等）
- **未檢查外部研究者或一般博物館觸及原住民族內容的案例**——是重要的樣本侷限
- 若未來發現外部策展案例的實踐品質不一致，應反向調整或增加 critical_gap 明述
- 平台層級仍無強制規範——這些高品質實踐依賴策展機構的自主選擇
